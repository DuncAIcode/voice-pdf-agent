...
export const tool$apiBillingGetV1BillingContractCommitments = {
...
Returns contract commitment terms in FOCUS v1.3 JSONL format`,
    tool: async (client, ctx) => {
        const [result, apiCall] = await apiBillingGetV1BillingContractCommitments(client, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
...
//# sourceMappingURL=apiBillingGetV1BillingContractCommitments.js.map